...
complexity and efficiency, similar to real converters that use databases to access outputs quickly.
...
public class Experiment {
	...
	public static class InvalidRoman extends Exception {
		public InvalidRoman (String message) {
			super (message);
		}
	}
	
	
	public static class OutOfInteger extends Exception {
		public OutOfInteger (String message) {
			super (message);
		}
	}
	...
	public static boolean repeatedNumerals (String y, char[] z) {
		...
		switch (y) {
		case "I": case "X": case "C": case "M": case "Q":
			max = 3;
			break;
		default:
			max = 1;
	 ...
	 * @throws Roman.OutOfInteger 
	 */
	public static int convertToInt (String r) throws InvalidRoman, OutOfInteger {
		int number = 0;
		int current = 0;
		...
		if (valid == false) throw new InvalidRoman ("Input a valid roman numeral from I-QQQMQCMXCIX.");
	...
	//Main Program
	public static void main(String[] args) throws IOException, InvalidRoman, OutOfInteger {
